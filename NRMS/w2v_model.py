...
class Model(nn.Module):
    def __init__(self, config):
        ...
        self.user_encoder = UserEncoder(hist_len, d_input, d_model, n_head, text_len)
    ...
    def forward(self, batch_datas):
        ...
        user_embedding = self.user_encoder(history_nids_words_embedding, history_words_len, history_len) # B, d_model
        news_embedding = self.user_encoder.news_encoder(impr_nid_words_embedding, impr_nid_words_len) # B, d_model
